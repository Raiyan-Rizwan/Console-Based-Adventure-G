...
import views.AdventureGameStartView;
...
public class AdventureGameApp extends  Application {
    ...
    AdventureGameStartView startView;
    ...
    * to call "launch" which will in turn call "start" ...
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        this.startView = new AdventureGameStartView(model); //start startView file after the GameView file, so it appears on top of the view window.
    }
