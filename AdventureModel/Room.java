...
public class Room implements Serializable {
    ...
    /**
     * The list of sounds you a player should hear in this room
     */
    public ArrayList<String> soundsInRoom = new ArrayList<String>();
    ...
    public String getObjectString() {
        String outputStr = "";
        for (AdventureObject item: objectsInRoom){
            if (outputStr.isEmpty()){
                outputStr += item.getDescription();
            } else {outputStr += "," + item.getName();}
        }
        return outputStr;
    }
    ...
    public String getCommands() {
        String outputStr = "";
        for (Passage path: motionTable.getDirection()){
            if (outputStr.isEmpty()){
                outputStr += path.getDirection();
            } else {outputStr += "," + path.getDirection();}
        }
        return outputStr;
    }
